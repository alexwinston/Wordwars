...
+ (WWGame *)gameFromData:(NSData *)data dictionary:(NSArray *)dictionary
{
    ...
    [playerStrings enumerateObjectsUsingBlock:^(NSString *playerString, NSUInteger index, BOOL *stop) {
        ...
        WWPlayer *player = [WWPlayer playerWithNumber:index name:playerNameString];
